...
export type ViewMode = 'chat' | 'session-list' | 'model-list' | 'agent-list' | 'settings' | 'queue-list' | 'rewind-selector' | 'tool-detail' | 'tool-list' | 'memory-list' | 'skill-list' | 'extension-list' | 'file-browser';
